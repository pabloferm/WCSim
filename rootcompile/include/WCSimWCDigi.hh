...
private:
  ...
  std::map<int, G4ThreeVector>    photonDir;
...
public:
  ...
  inline void SetPhotonDir(G4int gate, const G4ThreeVector &direction) { photonDir[gate] = direction; };
  ...
  inline G4ThreeVector  GetPhotonDir(int gate)    { return photonDir[gate];};
