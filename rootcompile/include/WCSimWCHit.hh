...
class WCSimWCHit : public G4VHit
{
 ...
 public:
  ...
  void AddPhotonDir  (const G4ThreeVector &photDir) { photonDir.push_back(photDir); }
...
reflectorID.size()++; 
  ...
  G4ThreeVector GetPhotonDir(int i) { return photonDir[i];};
 ...
 private:
  ...
  std::vector<G4ThreeVector> photonDir;
